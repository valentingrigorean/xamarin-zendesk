...
partial interface Constants
{
	// extern double ZendeskSDKVersionNumber;
	[Field ("ZendeskSDKVersionNumber", "__Internal")]
	double ZendeskSDKVersionNumber { get; }

	// extern NSString *const ZendeskSDKVersionString;
	[Field ("ZendeskSDKVersionString", "__Internal")]
	NSString ZendeskSDKVersionString { get; }
...
interface ZDKZendesk_ZendeskProviderSDK_Swift_487
{
