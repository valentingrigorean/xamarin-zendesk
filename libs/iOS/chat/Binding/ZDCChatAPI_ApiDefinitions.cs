...
partial interface Constants
{
	...
	[Field ("ZDC_CHAT_UI_DID_LOAD", "__Internal")]
	NSString ZDC_CHAT_UI_DID_LOAD { get; }

	// extern NSString *const ZDC_CHAT_UI_DID_LAYOUT;
	[Field ("ZDC_CHAT_UI_DID_LAYOUT", "__Internal")]
	NSString ZDC_CHAT_UI_DID_LAYOUT { get; }

	// extern NSString *const ZDC_CHAT_UI_WILL_UNLOAD;
	[Field ("ZDC_CHAT_UI_WILL_UNLOAD", "__Internal")]
	NSString ZDC_CHAT_UI_WILL_UNLOAD { get; }

	// extern NSString *const ZDC_NOTIFICATION_FILE_UPLOAD;
	[Field ("ZDC_NOTIFICATION_FILE_UPLOAD", "__Internal")]
	NSString ZDC_NOTIFICATION_FILE_UPLOAD { get; }
}
